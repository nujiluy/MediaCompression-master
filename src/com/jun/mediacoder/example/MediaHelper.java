...
public class MediaHelper {
   ...
   public  static void RotateVideo( String inPath,String outPath, int rotation ) { 
	   Log.i("1yyg", "RotateVideo==========rotation=>"+rotation);
	      try {
	         IsoFile file = new IsoFile( inPath );
	         ...
	         FileOutputStream videoFileOutputStream = new FileOutputStream( outPath );
